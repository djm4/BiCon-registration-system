...
<tr>
<td colspan=2><h2>Registration - register for BiCon</h2> <?= $warning ?>
</td>
</tr>
...
if ($region == 'ROW') {
 ...
 <tr>
<td colspan=2>Registration for BiCon/ICB from your country costs US $30, plus US $30 per night that you will be staying on-site. <input type="hidden" name="paymentlevel" value="A" /></td>
</tr>
  ...
  <?php
	...
	?>
<tr>
<td colspan=2>BiCon2010/10 ICB's ticket prices are based on your level of income, and the number of nights you will be staying on-site.</td>
</tr>
...
<tr>
<td align="right"><label for="paymentlevel">Please choose your annual<br>
level of income so that we
may calculate your ticket price.</label></td>
<td>
